<template>
    <div class="card">
        ...
        <ModalComponent
            ...
            :place="place"
        >
            <!-- <template v-slot:name> {{ place.attributes.name }}</template>
            <template v-slot:area> {{ place.attributes.area }} </template>
            <template v-slot:phone_code>
                {{ place.attributes.phone_code }} ||
                {{ place.attributes.postal_code }}
            </template>
